...
<div class="container mt-4">
	...
	<form action="{{ route('reception.appointments.update', $appointment) }}" method="POST" class="mt-3">
		@csrf
		@method('PUT')
		...
		<div class="mb-2">
			...
			<a href="{{ route('reception.appointments.index') }}" class="btn btn-secondary">إلغاء</a>
		</div>
	</form>
