                ...
                @foreach($doctors as $doctor)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.doctors.slots.index', $doctor) }}"
                               class="btn btn-sm btn-outline-secondary">
                                <i class="fa-solid fa-clock"></i> إدارة المواعيد
                            </a>

                            <form method="POST" action="{{ route('admin.doctors.destroy', $doctor) }}" onsubmit="return confirm('هل أنت متأكد من حذف هذا الطبيب؟');">
                                @csrf
                                @method('DELETE')
